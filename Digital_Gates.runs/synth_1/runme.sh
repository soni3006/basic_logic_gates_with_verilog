...
HD_PWD='F:/Xilinx_Vivado/Verilog_Projects/Youtube/Digital_Gates/Digital_Gates/Digital_Gates.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Digital_Gates.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Digital_Gates.tcl
